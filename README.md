...
- Exercício Python #013 - [Reajuste salarial](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex013.py)
- Exercício Python #014 - [Conversor de temperaturas](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex014.py)
- Exercício Python #015 - [Aluguel de carros](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex015.py)

#### Módulos

- Exercício Python #016 - [Quebrando um número](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex016.py)
- Exercício Python #017 - [Catetos e hipotenusa](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex017.py)
- Exercício Python #018 - [Seno, cosseno e tangente](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex018.py)
- Exercício Python #019 - [Sorteando um item na lista](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex019.py)
- Exercício Python #020 - [Sorteando uma ordem na lista](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex020.py)
- Exercício Python #021 - [Tocando um MP3](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex021.py)

#### Strings

- Exercício Python #022 - [Analisador de textos](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex022.py)
- Exercício Python #023 - [Separando dígitos de um número](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex023.py)
- Exercício Python #024 - [Verificando as primeiras letras de um texto](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex024.py)
- Exercício Python #025 - [Procurando uma string dentro de outra](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex025.py)
- Exercício Python #026 - [Primeira e última ocorrência de uma string](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex026.py)
- Exercício Python #027 - [Primeiro e último nome de uma pessoa](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex027.py)

#### Estruturas condicionais

- Exercício Python #028 - [Jogo da Adivinhação v1.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex028.py)
- Exercício Python #029 - [Radar eletrônico](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex029.py)
- Exercício Python #030 - [Par ou ímpar?](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex030.py)
- Exercício Python #031 - [Custo da viagem](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex031.py)
- Exercício Python #032 - [Ano bissexto](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex032.py)
- Exercício Python #033 - [Maior e menor valores](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex033.py)
- Exercício Python #034 - [Aumentos múltiplos](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex034.py)
- Exercício Python #035 - [Analisando triângulo v1.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_01/ex035.py)

### Mundo 2: estruturas de controle

#### Condições em Python (if..elif)

- Exercício Python #036 - [Aprovando empréstimo](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex036.py)
- Exercício Python #037 - [Conversor de bases numéricas](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex037.py)
- Exercício Python #038 - [Comparando números](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex038.py)
- Exercício Python #039 - [Alistamento militar](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex039.py)
- Exercício Python #040 - [Aquele clássico da média](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex040.py)
- Exercício Python #041 - [Classificando atletas](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex041.py)
- Exercício Python #042 - [Analisando triângulos v2.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex042.py)
- Exercício Python #043 - [Índice de Massa Corporal](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex043.py)
- Exercício Python #044 - [Gerenciador de pagamentos](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex044.py)
- Exercício Python #045 - [GAME: Pedra, Papel e Tesoura](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex045.py)

#### Repetições em Python (for)

- Exercício Python #046 - [Contagem regressiva](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex046.py)
- Exercício Python #047 - [Contagem de pares](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex047.py)
- Exercício Python #048 - [Soma ímpares múltiplos de três](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex048.py)
- Exercício Python #049 - [Tabuada v2.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex049.py)
- Exercício Python #050 - [Soma dos pares](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex050.py)
- Exercício Python #051 - [Progressão Aritmética](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex051.py)
- Exercício Python #052 - [Números primos](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex052.py)
- Exercício Python #053 - [Detector de palíndromo](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex053.py)
- Exercício Python #054 - [Grupo da maioridade](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex054.py)
- Exercício Python #055 - [Maior e menor da sequência](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex055.py)
- Exercício Python #056 - [Analisador completo](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex056.py)

#### Repetições em Python (while)

- Exercício Python #057 - [Validação de dados](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex057.py)
- Exercício Python #058 - [Jogo da adivinhação v2.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex058.py)
- Exercício Python #059 - [Criando um menu de opções](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex059.py)
- Exercício Python #060 - [Cálculo do fatorial](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex060.py)
- Exercício Python #061 - [Progressão aritmética v2.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex061.py)
- Exercício Python #062 - [Super Progressão Aritmética v3.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex062.py)
- Exercício Python #063 - [Sequência de Fibonacci v1.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex063.py)
- Exercício Python #064 - [Tratando vários valores v1.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex064.py)
- Exercício Python #065 - [Maior e menor valores](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex065.py)
- Exercício Python #066 - [Vários números com flag](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex066.py)
- Exercício Python #067 - [Tabuada v3.0](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_02/ex067.py)
...
- Exercício Python #072 - [Número por extenso](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_03/ex072.py)
- Exercício Python #073 - [Tuplas com times de futebol](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_03/ex073.py)
- Exercício Python #074 - [Maior e menor valores em tupla](https://github.com/zafraedu/Curso-Python-GustavoGuanabara/blob/main/mundo_03/ex074.py)
